...
func _on_area_entered(enemy_area: Object, bullets_custom_data: Resource, _bullet_global_position: Vector2) -> void:
...
# This function is connected to the body_entered signal of the bullet factory.  It is executed each time a bullet spawned from the factory hits a body (and again in order for a thing to be hit, ensure the layers are correct!)
func _on_body_entered(enemy_body: Object, bullets_custom_data: Resource, _bullet_global_position: Vector2) -> void:
