...
public:
    ...
    void push(MultiMeshBullets2D *multimesh, size_t amount_bullets);
    ...
    MultiMeshBullets2D *pop(size_t amount_bullets);
    ...
    void free_specific_bullets(size_t amount_bullets, bool pool_attachments);
...
private:
    ...
    std::unordered_map<size_t, std::queue<MultiMeshBullets2D*>> pool;
};
}