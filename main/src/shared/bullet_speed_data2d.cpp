...
float BulletSpeedData2D::get_speed() {
    return speed;
}
void BulletSpeedData2D::set_speed(float new_speed) {
    speed = new_speed;
}

float BulletSpeedData2D::get_max_speed() {
    return max_speed;
}
void BulletSpeedData2D::set_max_speed(float new_max_speed) {
    max_speed = new_max_speed;
}

float BulletSpeedData2D::get_acceleration() {
    return acceleration;
}
void BulletSpeedData2D::set_acceleration(float new_acceleration) {
