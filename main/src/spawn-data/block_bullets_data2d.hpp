...
class BlockBulletsData2D : public godot::Resource {
    GDCLASS(BlockBulletsData2D, godot::Resource);
...
public:
    ...
    godot::Vector2 texture_size = godot::Vector2(32, 32);
    ...
    godot::TypedArray<godot::Transform2D> transforms;
    ...
    godot::TypedArray<BlastBullets::BulletSpeedData> all_bullet_speed_data;
    ...
    godot::Vector2 collision_shape_size = godot::Vector2(5, 5);
    ...
    godot::Vector2 collision_shape_offset = godot::Vector2(0, 0);
    ...
    void set_transforms(godot::TypedArray<godot::Transform2D> new_transforms);

    godot::TypedArray<godot::Texture2D> get_textures() const;
    void set_textures(const godot::TypedArray<godot::Texture2D> &new_textures);
    ...
    void set_collision_shape_size(const godot::Vector2 &new_collision_shape_size);

    godot::Vector2 get_collision_shape_offset() const;
    void set_collision_shape_offset(const godot::Vector2 &new_collision_shape_offset);

    bool get_monitorable() const;
    void set_monitorable(bool new_monitorable);

    godot::Ref<godot::Resource> get_bullets_custom_data() const;
    void set_bullets_custom_data(const godot::Ref<godot::Resource> &new_bullets_custom_data);

    float get_max_life_time() const;
    void set_max_life_time(float new_max_life_time);

    godot::Ref<godot::Material> get_material() const;
    void set_material(const godot::Ref<godot::Material> &new_material);
    ...
    godot::TypedArray<BlastBullets::BulletSpeedData> get_all_bullet_speed_data();
    void set_all_bullet_speed_data(const godot::TypedArray<BlastBullets::BulletSpeedData> &new_data);
